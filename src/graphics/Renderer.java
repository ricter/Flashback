...
public class Renderer {
	...
	public void drawGameObjects() {
		...
		gameScreen.image(Flashback.backgroundImg, -Flashback.levelData.xDistanceFromLeftWall, 0);
		Flashback.levelData.draw(Flashback.levelData.xDistanceFromLeftWall, 0);
